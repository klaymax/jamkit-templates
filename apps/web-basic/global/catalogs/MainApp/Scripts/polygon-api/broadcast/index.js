var module = (function() {
    ...
    return {
        call: function(from, to, data, value) {
            return actions.invoke_app("__MAIN__", "api__web3_polygon_broadcast_call", {
                "from": from,
                "to": to,
                "data": data,
                "value": value
        ...
        create: function(from, to, data, value) {
            ...
            return actions.invoke_app("__MAIN__", "api__web3_polygon_broadcast_create", {
                "from": from,
                "to": to,
                "data": data,
                "value": value
        ...
        send: function(transaction) {
            ...
            return actions.invoke_app("__MAIN__", "api__web3_polygon_broadcast_send", {
        ...
        sign: function(message, account, password) {
            return actions.invoke_app("__MAIN__", "api__web3_polygon_broadcast_sign", {
                "message": message,
                "account": account,
                "password": password || ""
            })
